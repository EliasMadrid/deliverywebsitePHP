...
<html class="wide wow-animation" lang="en">
  <head>
    <title>The Best Of Brasil</title>
    <meta name="format-detection" content="telephone=no">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

    <meta http-equiv="content-type" content="text/html;charset=utf-8" />
    <meta name="description" content="comidas brasileiras, lanches, restaurantes ">
    <meta name="author" content="Elias Madrid">

    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta charset="utf-8">


    <link rel="icon" href="imagesbr/favicon-96x96.ico" type="image/x-icon">
    <!-- Stylesheets-->
  ...
  <body>
  <!-- CODIGO DO EFEITO DO PRELOADED DAS PAGINAS  -->
    <div class="preloader">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a title="ir para a pagina inicial" class="brand" href="index.php"><img src="imagesbr/logobr.jpg" alt="" width="196" height="47"/></a></div>
                </div>
                  ...
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <div class="rd-navbar-basket-wrap">
                      ...
                      <div class="cart-inline">
                        <div class="cart-inline-header">
                          ...
                          <h6 class="cart-inline-title">Preço total:<span> $800</span></h6>
                        </div>
                        ...
                        <div class="cart-inline-footer">
                          <div class="group-sm"><a class="button button-md button-default-outline-2 button-wapasha" href="#">Ir para o carrinho</a><a class="button button-md button-primary button-pipaluk" href="#">Pagamento</a></div>
                        </div>
                      </div>
                    ...
                    <div class="rd-navbar-search">
                      ...
                      <form class="rd-search" action="#">
                        <div class="form-wrap">
                          <label class="form-label" for="rd-navbar-search-form-input">Procurando...</label>
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="contatos.php">Contate-nos</a>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="rd-navbar-project rd-navbar-modern-project">
                  ...
                  <div class="rd-navbar-project-content rd-navbar-modern-project-content">
                    <div>
                      <p>Siga em nossas redes sociais.</p>
                      ...
                      <ul class="rd-navbar-modern-contacts">
                        <li>
                          <div class="unit unit-spacing-sm">
                            ...
                            <div class="unit-body"><a target="_blank" title ="Ir para o whatsapp"class="link-phone" href="http://api.whatsapp.com/send?1=pt_BR&phone=553191997971">+1 323-913-4688</a></div>
                          </div>
                        </li>
                        <li>
                          <div class="unit unit-spacing-sm">
